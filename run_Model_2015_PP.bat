:: template from tms6 L:\modelRuns\fy14\Ver2.3.56_no_outputs\run_ModelSteps_2020_final.bat
:: Run as Version 2.3.57
:: 2014-06-13 Friday 12:15

set root=.
set scenar=2015_PP
set runbat=run_ModelSteps_2015_PP.bat
