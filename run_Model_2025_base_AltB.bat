:: tms6 D:\modelRuns\fy15\Ver2.3.57_Conformity2014CLRP_Xmittal\run_Model_2025_base.bat
:: Version 2.3.57
:: 2014-09-20 Saturday 9:15

set root=.
set scenar=2025_base_AltB
set runbat=run_ModelSteps_2025_base_AltB.bat
