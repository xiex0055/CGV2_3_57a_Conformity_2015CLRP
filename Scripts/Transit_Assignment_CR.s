...
;  Output Files: WKCRAMnode.dbf; WKCRAMlink.dbf
; Step 2: AM Peak Drive, K/R Assignment
;  Input Files: ZONEHWY.NET, MODE?_AM.TB, *.TB, '%_iter_%_AMMS.TRP'
;  Output Files: DRCRAMnode.dbf; DRCRAMlink.dbf
; Step 3: Off Peak Walk Assignment
;  Input Files: ZONEHWY.NET, MODE?_OP.TB, *.TB, '%_iter_%_OPMS.TRP'
;  Output Files: WKCROPnode.dbf; WKCROPlink.dbf
; Step 4: Off Peak Drive, K/R Assignment
;  Input Files: ZONEHWY.NET, MODE?_OP.TB, *.TB, '%_iter_%_OPMS.TRP'
;  Output Files: DRCROPnode.dbf; DRCROPlink.dbf
;---------------------------------------------------------------------------
...
;---------------------------------------------------------------------------
; Step 1, 2, 3 & 4 Assign CR Transit Trips
;---------------------------------------------------------------------------
...
fileo supporto = supl_CR_@access_mode@_@time_period@.asc modes=11-16 oneway=t fixed=y
;
...
; output files
@WALK_MODEL@@AM@FILEO NODEO  = %_iter_%_WKCRAMnode.dbf ; output node file
@WALK_MODEL@@OP@FILEO NODEO  = %_iter_%_WKCROPnode.dbf ; output node file
@DRIVE_MODEL@@AM@FILEO NODEO = %_iter_%_DRCRAMnode.dbf ; output node file
@DRIVE_MODEL@@OP@FILEO NODEO = %_iter_%_DRCROPnode.dbf ; output node file

@WALK_MODEL@@AM@FILEO LINKO  = %_iter_%_WKCRAMlink.dbf ; output link file
@WALK_MODEL@@OP@FILEO LINKO  = %_iter_%_WKCROPlink.dbf ; output link file
@DRIVE_MODEL@@AM@FILEO LINKO = %_iter_%_DRCRAMlink.dbf ; output link file
@DRIVE_MODEL@@OP@FILEO LINKO = %_iter_%_DRCROPlink.dbf ; output link file
