...
; rm  4/7/08                      ;
; Added  table #19 (Total Transit time in min.) to output transit.temp.ab.skm file
; create total transit time skims named:                                   
;         %_iter_%_@TIME_PERIOD@_@ACCESS_MODE@_AB.ttt                     
...
fileo supporto = supl_@time_period@_@access_mode@_ab.asc modes=11-16 oneway=t fixed=y
fileo nodeo    = supn_@time_period@_@access_mode@_ab.dbf
fileo linko    = trnl_@time_period@_@access_mode@_ab.dbf   ; Can be used to create transit shapefile
...
;@dp_token@distributeIntrastep processId='mwcog', ProcessList=%subnode%
 MATI[1]=transit.temp.ab.skm
 MATO[1]=%_iter_%_@TIME_PERIOD@_@ACCESS_MODE@_AB.SKM, MO = 1-16,
 ...
 MATO[2]=%_iter_%_@TIME_PERIOD@_@ACCESS_MODE@_AB.STA, MO = 17-18,
  NAME = I_STA, J_STA

 MATO[3]=%_iter_%_@TIME_PERIOD@_@ACCESS_MODE@_AB.ttt, MO = 100,                ;
  NAME = sumtrntm
